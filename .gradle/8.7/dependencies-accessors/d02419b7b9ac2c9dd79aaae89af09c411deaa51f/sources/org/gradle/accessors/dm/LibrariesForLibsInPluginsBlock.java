...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    private final IrLibraryAccessors laccForIrLibraryAccessors = new IrLibraryAccessors(owner);
    ...
    /**
     * Dependency provider for <b>sdk</b> with <b>com.adivery:sdk</b> coordinates and
     * with version reference <b>sdk</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     *
     * @deprecated Will be removed in Gradle 9.0.
    ...
    /**
     * Group of libraries at <b>ir</b>
     *
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    public IrLibraryAccessors getIr() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return laccForIrLibraryAccessors;
    }
    ...
    public static class AndroidxLifecycleRuntimeKtxLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>v220alpha01</b> with <b>androidx.lifecycle:lifecycle-runtime-ktx</b> coordinates and
         ...
         */
        @Deprecated
        public Provider<MinimalExternalModuleDependency> getV220alpha01() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("androidx.lifecycle.runtime.ktx.v220alpha01");
        }
     ...
     */
    @Deprecated
    public static class IrLibraryAccessors extends SubDependencyFactory {
        private final IrTapsellLibraryAccessors laccForIrTapsellLibraryAccessors = new IrTapsellLibraryAccessors(owner);

        public IrLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>ir.tapsell</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public IrTapsellLibraryAccessors getTapsell() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForIrTapsellLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class IrTapsellLibraryAccessors extends SubDependencyFactory {
        private final IrTapsellPlusLibraryAccessors laccForIrTapsellPlusLibraryAccessors = new IrTapsellPlusLibraryAccessors(owner);

        public IrTapsellLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>ir.tapsell.plus</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public IrTapsellPlusLibraryAccessors getPlus() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForIrTapsellPlusLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class IrTapsellPlusLibraryAccessors extends SubDependencyFactory {
        private final IrTapsellPlusSdkLibraryAccessors laccForIrTapsellPlusSdkLibraryAccessors = new IrTapsellPlusSdkLibraryAccessors(owner);

        public IrTapsellPlusLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>ir.tapsell.plus.sdk</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public IrTapsellPlusSdkLibraryAccessors getSdk() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForIrTapsellPlusSdkLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class IrTapsellPlusSdkLibraryAccessors extends SubDependencyFactory {

        public IrTapsellPlusSdkLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>android</b> with <b>ir.tapsell.plus:tapsell-plus-sdk-android</b> coordinates and
         * with version reference <b>irTapsellPlusSdkAndroid</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
        ...
        public Provider<MinimalExternalModuleDependency> getAndroid() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("ir.tapsell.plus.sdk.android");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>irTapsellPlusSdkAndroid</b> with value <b>2.2.8</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getIrTapsellPlusSdkAndroid() { return getVersion("irTapsellPlusSdkAndroid"); }
        ...
        /**
         * Version alias <b>lifecycleRuntimeKtx</b> with value <b>2.2.0-alpha01</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>sdk</b> with value <b>4.6.5</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
